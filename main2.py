...
def initialize_chatbot():
    data_frame = read_csv_into_dataframe(r"C:\Users\ARPAGUPT\PycharmProjects\pythonProject\Ocr\Renewable_Energy_Final123 1.csv")  # Replace "path_to_your_csv_file.csv" with the path to your CSV file
